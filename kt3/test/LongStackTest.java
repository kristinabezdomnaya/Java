...
public class LongStackTest {
   ...
   @Test(timeout = 1000)
   public void testInterpretSupportsSWAP() {
      String s;
      s = "2 5 SWAP -";
      assertEquals("expression: " + s, 3, LongStack.interpret(s));

      s = "7 12 5 SWAP - *";
      assertEquals("expression: " + s, -49, LongStack.interpret(s));

      s = "3 5 7 SWAP SWAP + +";
      assertEquals("expression: " + s, 15, LongStack.interpret(s));
   }

   @Test(timeout = 1000)
   public void testInterpretSupportsROT() {
      String s;
      s = "2 5 9 ROT - +";
      assertEquals("expression: " + s, 12, LongStack.interpret(s));

      s = "7 3 9 1 ROT - - *";
      assertEquals("expression: " + s, 77, LongStack.interpret(s));

      s = "6 4 8 ROT ROT + -";
      assertEquals("expression: " + s, -2, LongStack.interpret(s));
   }

   @Test(timeout = 1000)
   public void testInterpretSupportsSWAPAndROT() {
      String s;
      s = "2 5 9 ROT + SWAP -";
      assertEquals("expression: " + s, 6, LongStack.interpret(s));

      s = "-3 4 2 SWAP ROT SWAP + -";
      assertEquals("expression: " + s, 1, LongStack.interpret(s));
   }
