...
public class QuaternionTest {
   ...
   public void testNegativeDigits() {
      ...
      assertEquals ("valueOf must read back what toString outputs. ",
              f, Quaternion.valueOf (f.toString()));
      f = new Quaternion (-1., -2., 3., 0.);
      assertEquals ("valueOf must read back what toString outputs. ",
              f, Quaternion.valueOf (f.toString()));
      f = new Quaternion (-2., -3.2, 0., 0.);
      assertEquals ("valueOf must read back what toString outputs. ",
              f, Quaternion.valueOf (f.toString()));
      f = new Quaternion (0., 0., -3., 4.);
      assertEquals ("valueOf must read back what toString outputs. ",
              f, Quaternion.valueOf (f.toString()));
      f = new Quaternion (-1., -2., -3., -4.);
      assertEquals ("valueOf must read back what toString outputs. ",
              f, Quaternion.valueOf (f.toString()));
      f = new Quaternion (-1., -2., 0., 0.);
      assertEquals ("valueOf must read back what toString outputs. ",
              f, Quaternion.valueOf (f.toString()));
      f = new Quaternion (0., -2., -3., -4.);
      assertEquals ("valueOf must read back what toString outputs. ",
              f, Quaternion.valueOf (f.toString()));
      f = new Quaternion (-1., -2., -3., 0.);
      assertEquals ("valueOf must read back what toString outputs. ",
      ...
      String s = "2-4i";
      assertEquals ("valueOf must read back what toString outputs. ",
              "2.0-4.0i", Quaternion.valueOf (s).toString());
   }

   @Test (expected=IllegalArgumentException.class)
   public void notAppropriatePlaceForComponents1() {
      Quaternion.valueOf("5 + 6kk + 8j + 8");
   }
   @Test (expected=IllegalArgumentException.class)
   public void notAppropriatePlaceForComponents2() {
      Quaternion.valueOf("5i + 6ii + 7jj + 8k");
   }
   @Test (expected=IllegalArgumentException.class)
   public void notAppropriatePlaceForComponents3() {
      Quaternion.valueOf("5j + 7 + 7k + 8i");
   }
   @Test (expected=IllegalArgumentException.class)
   public void notAppropriatePlaceForComponents4() {
      Quaternion.valueOf("5 + 1i + 7i + 8k");
   }
   ...
   public void testStrings(){
      String s = "2-6i";
      assertEquals("valueOf must read back what toString outputs. ",
              "2.0-6.0i", Quaternion.valueOf(s).toString());
      s = "-1-2i-3j-4k";
      assertEquals("valueOf must read back what toString outputs. ",
              "-1.0-2.0i-3.0j-4.0k", Quaternion.valueOf(s).toString());
      s = "-1-2i";
      assertEquals("valueOf must read back what toString outputs. ",
              "-1.0-2.0i", Quaternion.valueOf(s).toString());
      s = "-1-2i-3j";
      assertEquals("valueOf must read back what toString outputs. ",
              "-1.0-2.0i-3.0j", Quaternion.valueOf(s).toString());
      s = "-1";
      assertEquals("valueOf must read back what toString outputs. ",
              "-1.0", Quaternion.valueOf(s).toString());
   }
